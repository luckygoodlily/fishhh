      ...
      <?php
		...
		if( $userIdentify != null && $account != null  && $userCh != null && $areaTel != null && $Tel != null && $email != null ){
		  ...
		  if($_SESSION['UserAccount'] != null){
			...
			echo $id;
		    $sql = 'update userdata set Register_Account="'.$account.'", Register_Password="'.$password1.'",Client_User_Name_Ch="'.$userCh.'", Client_User_Name_En="'.$userEn.'", Client_User_Tele_Area_Code="'.$areaTel.'", Client_User_Tele="'.$Tel.'", Client_User_Tele_Ext="'.$telExt.'", Client_User_Email="'.$email.'", User_Identity="'.$userIdentify.'" where Register_Account="'.$id.'"';
