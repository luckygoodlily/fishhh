...
<html>
  ...
  <body>
    ...
    <div class="main" align="center">
	  ...
	  <table align="center">
        <tr align="center">
		   <td style="width:60px;"><p><a href="userDataFind.php"  target="_self" title="使用者資料管理"><img src="/Icon/b1.png" width="100" height="100"></a></p></td>
           <td><p><a href="findFishlightData.php"  target="_self" title="集魚燈資料管理"><img src="/Icon/b4.png" width="100" height="100"></a></p></td>
		   <td><p><a href="/fish/index.php"  target="_self" title="報表查詢"><img src="/Icon/b3.png" width="100" height="100"></a></a></p></td>
        </tr>
		<tr align="center">
		  <td style="width:60px;"><p>使用者資料管理</p></td>
          <td><p>集魚燈資料管理</p></td>
		  <td><p>報表查詢</p></td> 
        </tr>
	  </table> 
