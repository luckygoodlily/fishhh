...
<div>
  <table width=100% border="0"  align="center" >
    <tbody > 
      <tr>
        <td width="405"><a href="index.php"><img src="image/ab2.png" alt="" width="26" height="26"/></a><a href="../<?php echo $_SESSION['home']; ?>">首頁</a>><a href="index.php">報表查詢</a>><a href="UC0206-SS01.php">魚種辨識查詢</a>
...
<main align="center">
  <form name="form" method="post" action="UC0206-SS02.php">
	  <table width="800" border="1" align="center">
	    <tbody>
	      ...
	      <tr>
	        <th align="left" scope="row">2.請輸入公司名稱(英文)</th>
...
<select size="1" name="D3" id="D3" onchange="changeDate();">
  <script language="javascript">
    ...
    <p>
      <input type="submit" class="center" value="查詢" f>
    </p>
