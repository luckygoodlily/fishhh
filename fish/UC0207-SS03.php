...
<div>
  <table width=100% border="0"  align="center" >
    <tbody > 
      <tr>
        <td width="405"><a href="index.php"><img src="image/ab2.png" alt="" width="26" height="26"/></a><a href="../<?php echo $_SESSION['home']; ?>">首頁</a>><a href="index.php">報表查詢</a>><a href="UC0207-SS01.php">漁獲等級查詢</a><a href="index.php"></a></td>
